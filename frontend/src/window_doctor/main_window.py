...
class DoctorMainWindow(QMainWindow):
    ...
    def handle_disconnect(self):
        ...
        self.close()  # Close the med window
    ...
    def create_dashboard_page(self):
        ...
        welcome_label = QLabel("Welcome back, Doctor!")
    ...
    def load_dashboard_data(self):
        ...
        try:
            response = requests.get('http://127.0.0.1:8000/api/med/dashboard/'+str(self.user_data.get("id")), headers={"Authorization": f"Token {self.token}"})
