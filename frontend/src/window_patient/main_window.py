...
class PatientMainWindow(QMainWindow):
    ...
    def __init__(self, token, user_data):
        ...
        self.stacked_widget.addWidget(AppointmentsPage(self.theme_manager,self.token, self.user_data.get("id")))
        self.stacked_widget.addWidget(RepportsPage(self.theme_manager,self.token, self.user_data.get("id")))
    ...
    def handle_disconnect(self):
        ...
        self.close()  # Close the patient window
    ...
    def create_dashboard_page(self):
        ...
        welcome_label = QLabel("Welcome back, Sir")
        ...
        self.total_appointments_label = self.create_stat_card("Total Appointments", "Loading...", "📅", "")
    ...
    def load_dashboard_data(self):
        ...
        try:
            response = requests.get('http://127.0.0.1:8000/api/pat/dashboard/'+str(self.user_id)+'/', headers={"Authorization": f"Token {self.token}"})
